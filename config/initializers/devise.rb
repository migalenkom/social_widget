...
Devise.setup do |config|
  ...
  config.omniauth :facebook, ENV["FACEBOOK_KEY"], ENV["FACEBOOK_SECRET"], { :scope => 'email, publish_pages, user_posts, user_birthday, user_friends, user_likes, user_about_me, user_relationships, user_photos', info_fields: 'email', :client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}}
  ...
  config.omniauth :google_oauth2, ENV['GOOGLE_KEY'], ENV['GOOGLE_SECRET'], { prompt: 'consent', scope: 'userinfo.email userinfo.profile plus.login'}
  # ==> OmniAuth
